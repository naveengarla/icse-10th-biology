...
```mermaid
graph TD
    subgraph Chromosome ["A Replicated Chromosome (The Armored 'X')"]
        direction LR
        
        Chromatid1["Sister Chromatid 1<br>(Original DNA)"]
        Chromatid2["Sister Chromatid 2<br>(Exact Clone)"]
        Centromere(("CENTROMERE<br>(The Belt / Attachment Point)"))
        
        Spindle1>Spindle Fibre pulling North]
        Spindle2>Spindle Fibre pulling South]
        
        Chromatid1 --- Centromere
        Centromere --- Chromatid2
        
        Spindle1 -.->|Violently rips apart| Centromere
        Spindle2 -.->|Violently rips apart| Centromere
    end
    
    style Centromere fill:#ffcccb,stroke:#ff0000,stroke-width:3px
    style Chromatid1 fill:#add8e6,stroke:#0000ff
    style Chromatid2 fill:#add8e6,stroke:#0000ff
    style Spindle1 fill:#fffacd,stroke:#ffd700,stroke-dasharray: 5 5
    style Spindle2 fill:#fffacd,stroke:#ffd700,stroke-dasharray: 5 5
```
...
<div align="center">
  <img src="https://upload.wikimedia.org/wikipedia/commons/4/44/DNA_chromatin_chromosome.svg" width="600" alt="DNA packing into a chromosome">
  <br><i>The magnificent zoom: DNA string wrapping around Histone clusters, supercoiling into a Chromosome.</i>
</div>
...
<div align="center">
  <img src="https://upload.wikimedia.org/wikipedia/commons/e/e4/DNA_chemical_structure.svg" width="400" alt="DNA Double Helix and Base Pairing">
  <br><i>The rails are Sugar-Phosphate, the rungs are A-T and G-C!</i>
</div>
